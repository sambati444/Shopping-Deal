...
if(isset($_POST['submission']))
{
	...
	if(isset($_FILES['photo1']['tmp_name'])&&isset($_FILES['photo2']['tmp_name'])&&isset($_FILES['photo3']['tmp_name'])&&isset($_FILES['photo4']['tmp_name']))
	{
		...
		$query=mysql_query("INSERT INTO manage_product_master VALUES('$productid','','$category','$subcategory','$modelno','$productname','$manufacturer','$marketer','$quantity','$shippingprice','$saleprice','$oldprice','$tax','$purchaseprice','$weight','$weighttype','$width','$height','$lengthtype','$photo1','$photo2','$photo3','$photo4','$description','$dateofreg','$dateofreg','$special','0','0','0')")or die(mysql_error());
