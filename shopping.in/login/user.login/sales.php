        ...
        <div class="main-content">
			...
			<table id="myTable" class="display table">
				...
				if(isset($_GET['search']))
				{
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE order_no='$orderno' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
							{
								$customername=mysql_query("SELECT fname,lname FROM customer_master WHERE id='$row[customer_id]'")or die(mysql_error());
								$customername=mysql_result($customername,0,"fname").' '.mysql_result($customername,0,"lname");
								echo '<tr>
										<td>'.$sno.'</td>
										<td>'.$row['order_no'].'</td>
					...
					{
						$query=mysql_query("SELECT * FROM sale_order ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE shipping_city='$city' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE shipping_state='$state' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE orderdate='$sdate' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE orderdate BETWEEN '$sdate' AND '$edate' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE shipping_city='$city' AND orderdate='$sdate' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE shipping_city='$city' AND orderdate BETWEEN '$sdate' AND '$edate' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE shipping_state='$state' AND orderdate='$sdate' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE shipping_state='$state' AND orderdate BETWEEN '$sdate' AND '$edate' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
