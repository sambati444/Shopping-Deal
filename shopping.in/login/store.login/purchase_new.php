...
if(isset($_POST['submission']))
{
	...
	$query=mysql_query("INSERT INTO purchase_record VALUES('$id','$_SESSION[storeid]','$inwarddate','$purchasedate','$productname','$quantity')")or die(mysql_error());
	header("location:purchase_new.php?msg=success");
}
?>
<!doctype html>
<html lang="en"><head>
...
<!--LOADER AJAX-->
  ...
  <!--<![endif]-->
    ...
    <p class="stat"><span class="label label-danger">15</span> Overdue</p>-->
            ...
            <li class="active">Add New Purchase Record</li>
        </ul>
			...
			<form action="" method="post" enctype="multipart/form-data">
				<table class="table">
					...
					<tr>
						...
						<th>Quantity</th>
						<td>
							<input type="number" class="form-control" name="quantity" min="1" autofocus required/>
						</td>
					</tr>
					<tr>
