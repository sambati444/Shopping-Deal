  ...
  <!--<![endif]-->
    ...
    <p class="stat"><span class="label label-danger">15</span> Overdue</p>-->
        ...
        <div class="main-content" style="margin-bottom:140px;">
			<div id="dashboard">
				<div id="row1">
					<a href="sales.php?orderno=&status=&city=&state=&sdate=&edate=&search=Search"><div class="abhinav" style="background:#FF99CC;">Total Orders</div></a>
					<a href="sales.php?orderno=&status=NEW&city=&state=&sdate=&edate=&search=Search"><div class="abhinav" style="background:yellowgreen;">New Orders</div></a>
					<a href="sales.php?orderno=&status=PENDING&city=&state=&sdate=&edate=&search=Search"><div class="abhinav" style="background:coral;">Pending Orders</div></a>
				</div>
				<div id="row2">
					<a href="sales.php?orderno=&status=DISPATCH&city=&state=&sdate=&edate=&search=Search"><div class="abhinav2" style="background:#08C000;">Dispatched Orders</div></a>
					<a href="saels.php?orderno=&status=CANCEL&city=&state=&sdate=&edate=&search=Search"><div class="abhinav2" style="background:#FF0000;">Cancelled Orders</div></a>
				</div>
			</div>
		</div>
           <footer>
