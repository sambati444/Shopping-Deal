        ...
        <div class="main-content">
			...
			<table class="table" id="saleTable">
				...
				if(isset($_GET['search']))
				{
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE store_id='$_SESSION[storeid]' AND invoice_no!='' AND order_no='$orderno' ORDER BY orderdate")or die(mysql_error());
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE store_id='$_SESSION[storeid]' AND invoice_no!='' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE store_id='$_SESSION[storeid]' AND invoice_no!='' AND shipping_city='$city' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE store_id='$_SESSION[storeid]' AND invoice_no!='' AND shipping_state='$state' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE store_id='$_SESSION[storeid]' AND invoice_no!='' AND orderdate='$sdate' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE store_id='$_SESSION[storeid]' AND invoice_no!='' AND orderdate BETWEEN '$sdate' AND '$edate' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE store_id='$_SESSION[storeid]' AND invoice_no!='' AND shipping_city='$city' AND orderdate='$sdate' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE store_id='$_SESSION[storeid]' AND invoice_no!='' AND shipping_city='$city' AND orderdate BETWEEN '$sdate' AND '$edate' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE store_id='$_SESSION[storeid]' AND invoice_no!='' AND shipping_state='$state' AND orderdate='$sdate' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
					...
					{
						$query=mysql_query("SELECT * FROM sale_order WHERE store_id='$_SESSION[storeid]' AND invoice_no!='' AND shipping_state='$state' AND orderdate BETWEEN '$sdate' AND '$edate' ORDER BY orderdate")or die(mysql_error());
						if(mysql_num_rows($query)>=1)
						{
							$sno=1;
							while($row=mysql_fetch_array($query))
