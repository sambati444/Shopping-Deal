	...
	function formSubmission()
	{
		...
		if(trigger1=='1'&&trigger2=='1'&&trigger3=='1'&&trigger4=='1'&&trigger5=='1'&&trigger6=='1'&&trigger7=='1'&&trigger8=='1'&&trigger9=='1'&&trigger10=='1'&&trigger11=='1')
		{
			...
			xmlhttp.open("GET","web_require/web_ajax/step2_signup_formSubmission.php?friend="+friend+"&fname="+fname+"&lname="+lname+"&mobileno="+mobileno+"&emailid="+emailid+"&landlineno="+landlineno+"&faxno="+faxno+"&address="+address+"&country="+country+"&state="+state+"&city="+city+"&pincode="+pincode, true);
			xmlhttp.send();
		}
		/*END OF AJAX CODE*/
	}
