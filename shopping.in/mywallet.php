			...
			<div class="main-page">
				...
				<div class="page-content page-order">
		            ...
		            <div class="order-detail-content">
						<div class="row">
							<div class="col-md-12">
								<a href="myaccount.php" class="btn btn-info pull-right">My Orders</a>
							</div>
						</div>
		                <div class="row">
							<div class="col-sm-12">
								<div class="box-border">
									<div class="row">
										...
										<div class="col-md-4">
											<strong>Wallet Date &amp; Time</strong>
										</div>
										<div class="col-md-2">
								...
								<?php
									...
									$myorders=mysql_query("SELECT * FROM sale_wallet WHERE customerid='$myid'")or die(mysql_error());
									if(mysql_num_rows($myorders)>=1)
									{
										...
										while($row=mysql_fetch_array($myorders))
										{
											echo '<div class="row">
													...
													<div class="col-md-4">
														<a href="#">'.$row['orderno'].'</a>
													</div>
													<div class="col-md-4">
														<a href="#">'.date('d-M-Y h:i:sA',strtotime($row['dateTime'])).'</a>
													</div>
													<div class="col-md-2">
														<a href="#">Rs.'.$row['paise'].'/-</a>
													</div>
												</div>';
												$total=$total+$row['paise'];
												$s_no=$s_no+1;
										}
										echo '<div class="row">
													...
													<div class="col-md-2">
														<a href="#"><strong>Rs.'.$total.'/-</strong></a>
													</div>
												</div>';
									}
								?>
